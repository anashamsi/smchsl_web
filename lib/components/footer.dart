...
class Footer extends StatelessComponent {
    ...
    return footer(id: 'footer-section', classes: 'w-full bg-white pt-16 pb-8 border-t border-gray-100', [
      div(classes: 'max-w-7xl mx-auto px-6', [
        ...
        div(classes: 'grid grid-cols-1 md:grid-cols-3 gap-12 mb-16', [
          ...
          div([
            h2(classes: 'text-2xl font-bold text-[#F6921C] mb-6', [text("SMCHSL")]),
            ...
            h3(classes: 'text-lg font-bold text-[#F6921C] mb-4', [text("Important Links")]),
          ...
          // COLUMN 2: Contact Us
          div([
            h3(classes: 'text-lg font-bold text-[#F6921C] mb-6', [text("Contact Us")]),
            div(classes: 'space-y-4', [
              _contactItem('images/email.svg', 'shamsimercantilechsl@gmail.com'),
              _contactItem(
                'images/location.svg',
                'Office # 02, Ruby Heights, Jamal ud Din Afghani Road, Sharfabad, Karachi, Pakistan.',
              ),
              _contactItem('images/whatsapp.svg', '+92 333 1351353'),
              _contactItem('images/phone.svg', '021-34917503'),
              _contactItem('images/phone.svg', '021-34537503'),
            ]),
          ]),

          // COLUMN 3: Connect With Us
          div([
            h3(classes: 'text-lg font-bold text-[#F6921C] mb-6', [text("Connect With Us")]),
            div(classes: 'flex gap-4', [
              ...
              _socialIcon(
                ...
                'https://play.google.com/store/apps/details?id=com.hannanashraf12345.smchslappmobile',
              ),
            ]),
          ]),
        ]),
  ...
  Component _contactItem(String icon, String info) {
    return div(classes: 'flex items-start gap-3', [
      img(src: icon, classes: 'w-5 h-5 mt-1 opacity-80', alt: ''),
  ...
  Component _socialIcon(String icon, String url) {
    return a(
      href: url,
      classes:
          'w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center hover:bg-[#fbc689] group transition-all',
      [
        img(src: icon, classes: 'w-5 h-5 group-hover:text-white', alt: 'social'),
      ],
    );
  }
}
